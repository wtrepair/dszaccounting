...
const Newsletter: FunctionComponent<NewsletterType> = ({ className = "" }) => {
  return (
    <div
      className={`w-full bg-white border-t border-gray-100 py-8 px-4 sm:px-8 lg:px-8 flex flex-col items-center ${className}`}
    >
      <div className="w-full max-w-4xl shadow-lg rounded-lg bg-gray-50 flex flex-col md:flex-row items-center p-6 sm:p-8 gap-6">
        {/* Left Section */}
        <div className="flex-1 flex flex-col items-start gap-4 text-center px-4 md:text-left">
