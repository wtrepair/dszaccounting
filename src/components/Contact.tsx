...
const Contact: FunctionComponent<ContactType> = ({ className = "" }) => {
  return (
    <div className={`w-full max-w-4xl mx-auto p-8 text-center ${className}`}>
      ...
      <form className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <InputField labelText="First Name" placeholderText="Your name" showLabel />
          <InputField labelText="Last Name" placeholderText="Your last name" showLabel />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <InputField labelText="Email" placeholderText="example@email.com" showLabel />
          <InputField labelText="Phone Number" placeholderText="+1 (123) 456-7890" showLabel />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <SelectInput labelText="Country" placeholderText="Select your country" showLabel />
